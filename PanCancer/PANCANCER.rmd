...
STEP1
	Export vcf file according to this example (xxxx.VCF.vcf) in directory X:\PAT-Sequenzer\PANCANCER_INPUT_NXF\vcf_input
	Export txt/csv file according to this example(xxxx.CSV.csv) in directory X:\PAT-Sequenzer\PANCANCER_INPUT_NXF\csv_input
